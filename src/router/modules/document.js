    ...
    children: [
      {
        ...
        component: createNameComponent(() =>
          import("@/views/main/document/intro.vue")
        ),
      ...
      },
      {
        path: "menu",
        component: createNameComponent(() =>
          import("@/views/main/document/menu.vue")
        ),
      ...
      },
      {
        path: "crud",
        component: createNameComponent(() =>
          import("@/views/main/document/crud.vue")
        ),
      ...
      },
      {
        path: "theme",
        component: createNameComponent(() =>
          import("@/views/main/document/theme.vue")
        ),
      ...
      },
      {
        path: "api",
        component: createNameComponent(() =>
          import("@/views/main/document/api.vue")
        ),
