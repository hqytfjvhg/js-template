    ...
    children: [
      {
        ...
        component: createNameComponent(() =>
          import("@/views/main/echarts/bar.vue")
        ),
      ...
      },
      {
        path: "line",
        component: createNameComponent(() =>
          import("@/views/main/echarts/line.vue")
        ),
      ...
      },
      {
        path: "pie",
        component: createNameComponent(() =>
          import("@/views/main/echarts/pie.vue")
        ),
      ...
      },
      {
        path: "radar",
        component: createNameComponent(() =>
          import("@/views/main/echarts/radar.vue")
        ),
      ...
      },
      {
        path: "map",
        component: createNameComponent(() =>
          import("@/views/main/echarts/map.vue")
        ),
